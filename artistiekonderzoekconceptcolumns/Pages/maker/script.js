...
var pg = {
	...
	languageParts: {
		...
		'een': 'een'.split('|'),
		'x': 'goede|grote|kleine|biculturele|vrouwelijke|crossmediale|multimediale|digitale|analoge|transmediale|innovatieve|nieuwe|controversiele|traditionele|jonge|'.split('|'),
