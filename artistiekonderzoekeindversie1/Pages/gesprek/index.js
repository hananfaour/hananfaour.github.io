...
var ENTRIES = [{
        ...
        // Biculturele schrijver
        id: 'e_23',
        text: 'Dus het gaat over biculturaliteit?',
        options: [{
            text: 'Nee, het gaat over deze familie. Het mag dan wel autobiografische elementen hebben, maar dat gaat niet altijd over cultuur.',
            goto: 'e_24'
        }]
    }, {
        // Biculturele verhaal
        id: 'e_23',
        text: 'Maar waarom is het autofictie als het niet gaat over biculturaliteit?',
        options: [{
            text: 'Omdat niet alles wat jouw leven jouw leven maakt te maken heeft met cultuur.',
            goto: 'e_24'
        }]
    }, {
        // Biculturele verhaal belangrijk
        id: 'e_24',
        text: 'Maar als het moet, hoe zou je het dan omschrijven?',
        options: [{
        ...
        // Biculturele verhaal belangrijk
        id: 'e_25',
        text: 'Niet meer dan dat?',
        options: [{
            text: 'Het is gewoon een verhaal over een familie, en het is dan wel autofictie maar dat betekent niet dat het alleen maar over cultuur gaat. Je wil het niet in een specifieke categorie stoppen.',
            goto: 'e_26'
        }]
